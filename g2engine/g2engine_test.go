...
func ExampleG2engine_HowEntityByEntityID() {
	...
	fmt.Println(util.Flatten(util.NormalizeAndSortJson(result)))
...
func ExampleG2engine_SearchByAttributes() {
	...
	fmt.Println(util.Flatten(util.RedactJson(util.Flatten(util.NormalizeAndSortJson(result)), "FIRST_SEEN_DT", "LAST_SEEN_DT")))
