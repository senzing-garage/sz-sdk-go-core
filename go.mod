...
require (
	...
	github.com/senzing-garage/go-logging v1.4.2-0.20240606220231-55bff7047ff5
...
require (
	...
	github.com/senzing-garage/go-messaging v1.5.1-0.20240606220034-73bf91eb5e93 // indirect
