...
import (
	...
	szproductapi "github.com/senzing-garage/g2-sdk-go/szproduct"
...
func getTestObject(ctx context.Context, test *testing.T) szapi.G2product {
	_ = ctx
	_ = test
	return &globalG2product
}

func getG2Product(ctx context.Context) szapi.G2product {
	_ = ctx
	return &globalG2product
}
...
func testError(test *testing.T, ctx context.Context, g2product szapi.G2product, err error) {
	_ = ctx
	_ = g2product
	if err != nil {
...
// func testErrorNoFail(test *testing.T, ctx context.Context, g2product szapi.G2product, err error) {
// 	if err != nil {
// 		test.Log("Error:", err.Error())
// 	}
// }
